...
function Condo() {
  ...
  function saveForm(event) {
    ...
    api.saveProperty(propertyId, {
      address: form.address,
      homeowner: form.homeowner,
      inspector: form.inspector,
      reportnumber: form.reportnumber,
      frontdoorcomment: form.frontdoorcomment,
      ...
      <div className="container" id="divToPrint">
        <section id="section-1">
          ...
          <form onChange={handleInputChange}>
            ...
            <input name="address" type="text" class="form-control" id="info" aria-describedby="emailHelp" placeholder={prevForm.address ? prevForm.address : "Address here"}></input>
            <br />
            <br />
            <div htmlFor="info" id="info">
              This confidential report is prepared exclusively for:
        </div>
            <input name="homeowner" type="text" class="form-control" id="info" placeholder={prevForm.homeowner ? prevForm.homeowner : "Homeowner"}></input>
            <br />
            <br />
            <div htmlFor="info" id="info">
              Prepared By:
        </div>
            <input name="inspector" type="text" id="info" className="form-control" placeholder={prevForm.inspector ? prevForm.inspector : "inspector"} />
            <br />
            <br />
            <div htmlFor="info" id="info">
              Report Number:
        </div>
            <input name="reportnumber" type="text" id="info" className="form-control" placeholder={prevForm.reportnumber ? prevForm.reportnumber : "report number"} />
            <br />
            <br />
            <div htmlFor="info" id="info">
        ...
        <section id="section-3">
          ...
          <form onChange={handleInputChange}>
            <div>
              <input type="checkbox" name="peephole" />peephole with knocker&nbsp;&nbsp;
            <br></br>
            ...
            <textarea style={{ width: '100%', maxWidth: '100%' }} defaultValue={""} name="frontdoorcomment" type="text" id="info" placeholder={prevForm.frontdoorcomment ? prevForm.frontdoorcomment : "Comments"} />
            <div>
